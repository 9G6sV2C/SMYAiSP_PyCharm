...
if __name__ == '__main__':
    ...
    gr2 = '4247-000000D'
    gr3 = '4243-111111D'
    groupChoice = tk.StringVar(value=gr1)
    ...
    ckbFavSubj1 = tk.Checkbutton(frm3, text="Матан", variable=favSubj1_status)
    favSubj2_status = tk.IntVar()
    ckbFavSubj2 = tk.Checkbutton(frm3, text="Прога", variable=favSubj2_status)
    favSubj3_status = tk.IntVar()
    ckbFavSubj3 = tk.Checkbutton(frm3, text="Физра", variable=favSubj3_status)
    favSubj4_status = tk.IntVar()
    ckbFavSubj4 = tk.Checkbutton(frm3, text="Диффуры", variable=favSubj4_status)
    favSubj5_status = tk.IntVar()
    ckbFavSubj5 = tk.Checkbutton(frm3, text="История", variable=favSubj5_status)
    lblFavSubj.pack()
    ckbFavSubj1.pack()
    ckbFavSubj2.pack()
    ckbFavSubj3.pack()
